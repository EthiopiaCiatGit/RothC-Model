...
setwd(final)
Vector <- readOGR("target_points.shp")
...
setwd(workspace)
PREC <- stack("Prec_Stack_216_01-18.tif")
TEMP <- stack("Temp_Stack_216_01-18.tif")
PET <- stack("PET_Stack_216_01-18.tif")

#Open Mean NPP MIAMI 1981 - 2000
NPP <- raster("NPP_MIAMI_MEAN_81-00_AOI.tif")
...
NPP <-
  (LU_AOI == 4) * NPP * 0.53 + (LU_AOI == 1) * NPP * 0.88 + (LU_AOI == 3 |
                                                               LU_AOI == 5 | LU_AOI == 7) * NPP * 0.72
NPP_MEAN_MIN <-
  (LU_AOI == 4) * NPP_MEAN_MIN * 0.53 + (LU_AOI == 1) * NPP_MEAN_MIN * 0.88 + (LU_AOI ==
                                                                                 3 | LU_AOI == 5 | LU_AOI == 7) * NPP_MEAN_MIN * 0.72
NPP_MEAN_MAX <-
  (LU_AOI == 4) * NPP_MEAN_MAX * 0.53 + (LU_AOI == 1) * NPP_MEAN_MAX * 0.88 + (LU_AOI ==
                                                                                 3 | LU_AOI == 5 | LU_AOI == 7) * NPP_MEAN_MAX * 0.72
...
NPP_M[w]<-(LU_im[i]==4)*NPP_M[w]*0.53+ (LU_im[i]==1)*NPP_M[w]*0.88 + (LU_im[i]==3 | LU_im[i]==5 | LU_im[i]==7)*NPP_M[w]*0.72
...
NPP_M_MIN[w]<-(LU_im[i]==4 )*NPP_M_MIN[w]*0.53+ (LU_im[i]==1)*NPP_M_MIN[w]*0.88 + (LU_im[i]==3 | LU_im[i]==5 | LU_im[i]==7)*NPP_M_MIN[w]*0.72
...
NPP_M_MAX[w]<-(LU_im[i]==4)*NPP_M_MAX[w]*0.53+ (LU_im[i]==1)*NPP_M_MAX[w]*0.88 + (LU_im[i]==3 | LU_im[i]==5 | LU_im[i]==7)*NPP_M_MAX[w]*0.72
